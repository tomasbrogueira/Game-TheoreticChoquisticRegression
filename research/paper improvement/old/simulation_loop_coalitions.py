...
def simulation(
        ...
        for method in methods:
            ...
            if method == "choquet":
                try:
                    ...
                    choquet_coalitions.append(all_coalitions)
                    v = coef[0]
            ...
            if method == "choquet_2add":
                ...
                choquet_2add_coalitions.append(all_coalitions_2add)
    ...
    if shapley_full and marginal_full and "choquet" in interaction_matrices_dict and len(interaction_matrices_dict["choquet"]) > 0:
        ...
        from simulation_helper_functions import shapley_interaction_index
        nAttr = X_train.shape[1]
        ...
        from plotting_functions import plot_overall_interaction  # Assumed available
        feature_names = get_feature_names(X)
        overall_dict = {
